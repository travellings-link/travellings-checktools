<template>
  <mdui-card class="p-5 my-10 sm:w-80%">
    <div class="">
      ...
      <mdui-button full-width @click="redirectToGitHub" :loading="redirecting" :disabled="redirecting">
...
function redirectToGitHub() {
  ...
  window.location.href = 'https://api.travellings.cn/login/github?redirect_url=https://check-tools.travellings.cn/'
}
</script>